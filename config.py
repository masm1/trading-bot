...
MARKET_OPEN_WATCHLIST_FILE = get_env("MARKET_OPEN_WATCHLIST_FILE", "auto_watchlist.csv")
...
AUTO_DISCOVERY_LOOKBACK_DAYS = int(get_env("AUTO_DISCOVERY_LOOKBACK_DAYS", "7"))
...
DISCOVERY_EXTRA_SYMBOLS = get_env("DISCOVERY_EXTRA_SYMBOLS", "")
